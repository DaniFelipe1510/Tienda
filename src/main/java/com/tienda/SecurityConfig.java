...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    //@Bean es como el autowired que inyectaba dependencias, peeero inyectamos dependencias pero de configuracion que debe hacer el programa cuando se esta ejecutando
    @Bean
